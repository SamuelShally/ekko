            ...
            <div className='absolute w-screen z-20'>
                <div className="relative inset-y-36">
                    ...
                    {/* <div className='absolute top-10 z-10'> */}
                        {/* <footer className="footer footer-center p-10 bg-neutral text-primary">
                            <div>
                                <img className="w-1/5" src={ekkoO}></img>
                                    ...
                                    <p className="font-bold pb-6">Copyright © 2022 - All right reserved</p>
                                </div> 
                                <div>
