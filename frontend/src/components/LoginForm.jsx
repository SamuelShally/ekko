                ...
                <div className="relative grid gap-y-14 place-content-center h-screen z-0 
                    ...
                    <div className='grid gap-y-8 border-2 rounded-xl shadow-xl mt-16 p-10 mx-10 sm:mt-0'>
                        <div>
                            ...
                            <h1 className=" font-semibold text-3xl lg:text-4xl">Welcome back</h1>
                        </div>
                    <form className="grid gap-6">
                        ...
                        <input type="text" placeholder="Username"
                                ...
                                font-light text-xs shadow-inner"
                                value={username}
                        ...
                        <button
                            ...
                            px-20 w-80 btn-md hover:bg-neutral hover:text-primary hover:shadow-inner"
                            onClick = {submitForm}>
                                Sign in
                            </button>
                        </Link>
                    ...
                    {error && 
                            <div className="alert shadow-lg bg-secondary text-neutral rounded-lg -mt-2 p-4 text-center justify-center max-w-s">
