                ...
                <div className="grid gap-5 max-w-lg mx-auto py-6 bg-neutral rounded-lg 
                    ...
                    <div className='mt-4 mx-4 rounded-xl shadow-lg overflow-hidden bg-white'> {/* card 1 */}
                        ...
                        <div className='p-4'>
                            ...
                            <h3 className='mt-2 text-2xl sm:text-3xl font-semibold leading-7 text-gray-900'>8 facts about gender equality you must know</h3>
                            ...
                            <div className='mt-6 flex items-center'> {/* author-1 info container */}
                                ...
                                <div className='ml-4 align-middle '>
                                    <p className='text-sm sm:text-lg leading-5 font-medium text-primary'>Author name</p>
                    ...
                    <div className='mt-4 mx-4 rounded-xl shadow-lg overflow-hidden bg-white'> {/* card 2 */}
                        ...
                        <div className='p-4'>
                            <p className='text-secondary sm:text-lg'>Blog</p>
                            <h3 className='mt-2 text-2xl sm:text-3xl font-semibold leading-7 text-gray-900'>5 Ways Abortion Rights Protect Women's Health</h3>
                            <p className='mt-2 leading-6 sm:text-lg text-gray-400 font-light'>
                                Lorem ipsum dolor sit amet. Eos repellendus unde sit omnis accusantium.
                            </p>
