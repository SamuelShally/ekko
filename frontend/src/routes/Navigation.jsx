      ...
      <div className="flex-none p-2">
        <ul className="menu menu-horizontal">
          ...
          <li>
            <Link to="/register">
              <button className="btn btn-md text-lg
                                 sm:btn-md sm:text-2xl
                                 md:btn-lg md:text-2xl 
                                 text-neutral rounded-full hover:text-secondary hover:bg-transparent bg-primary
                                 ">
                Sign up
              </button>
            </Link>
